                        ...
                        <CardContent className="p-4">
                          ...
                          {selectedEmployee === employee.id && (
                            <div className="mt-4 pt-4 border-t border-gray-200">
                              <div className="space-y-3">
                                <div>
                                  <h5 className="font-medium text-gray-900 text-sm mb-1">Specialization</h5>
                                  <p className="text-xs text-gray-600">{employee.specialization}</p>
                                </div>
                                <div>
                                  <h5 className="font-medium text-gray-900 text-sm mb-1">All Skills</h5>
                                ...
                                <Button
                                  ...
                                  className="w-full bg-gradient-to-r from-[#71389A] to-[#8B4CB8] hover:from-[#5F2D85] hover:to-[#71389A] text-white text-sm py-2 disabled:opacity-50"
                                >
                                  <Building className="w-4 h-4 mr-2" />
                                  {employee.availability === "Available" ? "Request to Hire" : "Currently Busy"}
                                </Button>
                              </div>
                            </div>
                          )}
